...
//ya pr user creat or login hoga
describe('User addresses API', () => {
    beforeAll(async () => {
        await connectDB();
    });

    //user ko yaha first bnaya za raha hai
    async function seedUserAndLogin({ username = 'addr_user', email = 'addr@example.com', password = 'Secret123!' } = {}) {
        ...
        //abhi yaha pr user ko login krwaya za raha hai
    ...
    //asli kaam testing ka yaha pr hoga
      describe('GET /api/auth/users/me/addresses', () => {
        ...
        it('returns a list of addresses and indicates a default', async () => {
            ...
            // yaha pr apne taraf ye address daal raha hu directly
            user.addresses.push(
    ...
    // yaha pr address creat ho raha hai
